...
## Types of Radial Distortion {.smaller-text}
...
![Barrel Distortion](media/Barrel_distortion.svg){width="300"}
...
![Pincushion Distortion](media/Pincushion_distortion.svg){width="300"}
...
![Mustache Distortion](media/Mustache_distortion.svg){width="400"}
...
::: {.video-container}
![Grid and Checkerboard](media/grid_and_checkerboard.svg){height="450"}
:::
...
::: {.video-container}
{{< video videos/extracted/07_vlm_specify_part_to_grab.mp4 autoplay=true controls=true loop=true height="500" >}}
:::
...
1. Open the VLM system prompt in the robot control code
2. Add a rule that tells the VLM to **never pick up objects with warning signs** near them
3. Test your modified prompt with the knife scene
